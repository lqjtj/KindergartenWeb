 ...
 <div style="margin-top: 15px;width:60%;">
  <el-input placeholder="请输入内容" v-model="svalue">
    <el-select v-model="sname" slot="prepend" placeholder="请选择">
      <!--<el-option label="角色id" value="roleId"></el-option>-->
     ...
     handleSizeChange(val) {
      ...
      onPost() {
       ...
       var params = new URLSearchParams();
         ...
         //   alert(scondition);
       var params_json={userId:'15122922900',action:'role_list',param1:scondition,param2:this.pageSize.toString(),param3:this.currentPage.toString(),param4:'',param5:''};
         ...
         this.$http.post('/KindergartenWeb/action/query.do',params_json,{withCredentials:false}).then(function (res) {
          //  alert(JSON.stringify(res))
            for (let i = 0; i < res.data.rows.length; i++) {
                ...
                obj.roleId = res.data.rows[i].roleId
      ...
      setCurrent(){
          ...
          this.update.roleId=this.currentRow.roleId;
